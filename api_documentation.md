...
https://ucp-fr.gta.world/oauth/authorize?client_id=YOUR_CLIENT_ID&redirect_uri=YOUR_CALLBACK_URL&response_type=code&scope=
...
POST https://ucp-fr.gta.world/oauth/token
Parameters:
...
Host: ucp-fr.gta.world
Authorization: Bearer YOUR_ACCESS_TOKEN
Endpoints
Endpoint	Method	Description
https://ucp-fr.gta.world/oauth/authorize	GET	Redirect user for authentication.
https://ucp-fr.gta.world/oauth/token	POST	Exchange authorization code for an access token.
https://ucp-fr.gta.world/api/user	GET	Access protected user data.
CURL Examples
1. Requesting an Access Token
curl -X POST https://ucp-fr.gta.world/oauth/token \
...
curl -H "Authorization: Bearer YOUR_ACCESS_TOKEN" https://ucp-fr.gta.world/api/user
PHP Examples
1. Requesting an Access Token (cURL)
<?php
// Define the token URL and parameters
$tokenUrl = 'https://ucp-fr.gta.world/oauth/token';
$postData = [
    'grant_type'    => 'authorization_code',
    'client_id'     => 'YOUR_CLIENT_ID',
    'client_secret' => 'YOUR_CLIENT_SECRET',
...
$userUrl = 'https://ucp-fr.gta.world/api/user';
...
$client = new Client();
$response = $client->request('POST', 'https://ucp-fr.gta.world/oauth/token', [
    'form_params' => [
        'grant_type'    => 'authorization_code',
        'client_id'     => 'YOUR_CLIENT_ID',
        'client_secret' => 'YOUR_CLIENT_SECRET',
...
async function getAccessToken() {
  try {
    const response = await axios.post('https://ucp-fr.gta.world/oauth/token', null, {
      params: {
        grant_type: 'authorization_code',
        client_id: 'YOUR_CLIENT_ID',
        client_secret: 'YOUR_CLIENT_SECRET',
...
async function getUserData() {
  try {
    const response = await axios.get('https://ucp-fr.gta.world/api/user', {
      headers: {
        Authorization: 'Bearer YOUR_ACCESS_TOKEN'
      }
    });
...
url = "https://ucp-fr.gta.world/oauth/token"
payload = {
    "grant_type": "authorization_code",
    "client_id": "YOUR_CLIENT_ID",
    "client_secret": "YOUR_CLIENT_SECRET",
...
url = "https://ucp-fr.gta.world/api/user"
headers = {
    "Authorization": "Bearer YOUR_ACCESS_TOKEN"
}
