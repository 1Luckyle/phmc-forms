        ...
        <>
            ...
            {isPersonalInfoOpen && (
                <div id="collapse-nursing-personal-info" style={{ paddingTop: '0.5rem' }}>
                    <Form.Group className="mb-3">
                        ...
                        >
                            <option value="">Sélectionner un poste d'infirmière...</option>
                    ...
                    {isSpecificNurseRole && (
                        <Form.Group className="mb-3">
                            <Form.Label>1.6 Lieu d'emploi souhaité</Form.Label>
                            <div
                                onBlur={() => handleSectionFieldBlur('personalInfo', isPersonalInfoOpen, setIsPersonalInfoOpen, 'personalInfo')}
                                className="mb-4"
                            >
                    ...
                    <Form.Group className="mb-3">
                        <Form.Label>{isSpecificNurseRole ? "1.7" : "1.6"} Avez-vous été diagnostiqué avec une condition médicale, des allergies, ou vous a-t-on prescrit des médicaments?</Form.Label>
                        <Form.Control
                    ...
                    <Form.Group className="mb-3">
                        <Form.Label>{isSpecificNurseRole ? "1.8" : "1.7"} Citoyenneté</Form.Label>
                        <div
                            onBlur={() => handleSectionFieldBlur('personalInfo', isPersonalInfoOpen, setIsPersonalInfoOpen, 'personalInfo')}
                            className="mb-4"
                        >
            ...
            {isOocInfoOpen && (
                <div id="collapse-nursing-ooc-info" style={{ paddingTop: '0.5rem' }}>
                    ...
                    <Form.Group className="mb-3">
                        <Form.Label>5.5 Avez-vous une expérience médicale réelle ou avez-vous joué des rôles médicaux dans le passé? Décrivez en détail:</Form.Label>
