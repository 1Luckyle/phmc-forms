...
export const formDefinitions = [
    ...
    { version: 5, name: "Opération Chirurgicale", group: "PHMC", icon: surgeon, generator: generateSurgicalOps, FieldComponent: Surgical, titleKey: "operationChirurgicale", sortOrder: 20, titleGenerator: (formData) => `Opération Chirurgicale: ${formData.patientID || 'Inconnu'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },    { version: 6, name: "Évaluation Physique", group: "PHMC", icon: nurse, generator: generatePhysEvalInternalMed, FieldComponent: PhysEval, titleKey: "evaluationPhysique", sortOrder: 21, titleGenerator: (formData) => `Évaluation Physique: ${formData.patientID || 'Inconnu'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },
    ...
    { version: 19, name: "Protocole d'Urgence", group: "PHMC", icon: emergency, generator: generateEmergencyProtocol, FieldComponent: EmergencyForm, titleKey: "protocoleUrgence", sortOrder: 25, titleGenerator: (formData) => `Protocole d'Urgence: ${formData.patientID || 'Inconnu'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },
    { version: 20, name: "Consultation Générale", group: "PHMC", icon: empathy, generator: generateConsultationNotesPHMC, FieldComponent: GeneralConsult, titleKey: "consultationGeneralePHMC", sortOrder: 26, titleGenerator: (formData) => `Consultation Générale: ${formData.patientID || 'Inconnu'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },
    // Add isHiddenInSelector: true to the PBC version
    { version: 21, name: "Consultation Générale (PBC)", group: "PHMC", icon: phmcpaletobay, generator: generateConsultationNotesPBC, FieldComponent: GeneralConsult, titleKey: "consultationGeneraletPBC", sortOrder: 27, isHiddenInSelector: true, titleGenerator: (formData) => `Consultation Générale: ${formData.patientID || 'Inconnu'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },
    { version: 22, name: "Note de Service", group: "PHMC", icon: paperwork, generator: generateCommentaryNotePHMC, FieldComponent: CommNotePHMC, titleKey: "noteServicePHMC", sortOrder: 28, titleGenerator: (formData) => `Note de Service: ${formData.patientID || 'Inconnu'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },
    // Add isHiddenInSelector: true to the PBC version
    { version: 23, name: "Note de Service (PBC)", group: "PHMC", icon: phmcpaletobay, generator: generateCommentaryNotePBC, FieldComponent: CommNotePBC, titleKey: "noteServicePBC", sortOrder: 29, isHiddenInSelector: true, titleGenerator: (formData) => `Note de Service: ${formData.patientID || 'Inconnu'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },
    { version: 27, name: "PHMC Email Interne", group: "PHMC", icon: emailIcon, generator: generateEmailPHMCEmail, FieldComponent: EmailInternal, titleKey: "phmcEmailInterne", sortOrder: 30, titleGenerator: (formData) => `Email Interne: ${formData.patientNotes || 'Aucun Sujet'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },
    { version: 28, name: "Évaluation Psychologique", group: "PHMC", icon: psychology, generator: generatePsychEvalPHMC, FieldComponent: Shrink, titleKey: "evaluationPsychologiquePHMC", sortOrder: 31, titleGenerator: (formData) => `Évaluation Psychologique: ${formData.patientID || 'Inconnu'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },
    // Add isHiddenInSelector: true to the PBC version
    { version: 29, name: "Évaluation Psychologique (PBC)", group: "PHMC", icon: phmcpaletobay, generator: generatePsychEvalPBC, FieldComponent: Shrink, titleKey: "evaluationPsychologiquePBC", sortOrder: 32, isHiddenInSelector: true, titleGenerator: (formData) => `Évaluation Psychologique: ${formData.patientID || 'Inconnu'}`, userTypes: ['phmcStaff', 'other'], primaryFor: ['phmcStaff'] },
