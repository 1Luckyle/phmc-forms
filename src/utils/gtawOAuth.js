...
// soit le flux (onboarding, connexion employé, connexion admin). Le client
// OAuth GTA World (ucp-fr.gta.world) n'autorise qu'UNE SEULE URL de callback
// enregistrée : on doit donc toujours rediriger vers cette même URL, et
// mémoriser le flux en cours dans sessionStorage pour que GtaCallback.js
// sache quoi en faire au retour.
 ...
 * @param {{ type: 'onboarding'|'employee-login'|'admin-login', [key: string]: any }} flow
 */
